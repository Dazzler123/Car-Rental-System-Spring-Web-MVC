                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                        ...
                                        <div id="collapse${id}" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body text-secondary">
                                                ...
                                                <ul class="list-group list-group-horizontal">
                                                    ...
                                                    <li class="list-group-item col-5">${vehicle.fuel_type}</li>
                                                </ul>
                                                <ul class="list-group list-group-horizontal">
                                                ...
                                                <ul class="list-group list-group-horizontal">
                                                    ...
                                                    <li class="list-group-item col-5">${vehicle.passenger_count}</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <ul class="list-group list-group-horizontal fw-bold mt-2">
                                    ...
                                    <li class="list-group-item list-group-item-primary col-3">${vehicle.daily_rate}</li>
                                </ul>
                                <ul class="list-group list-group-horizontal fw-bold">
                                    <li class="list-group-item list-group-item-primary col-9">Daily KM</li>
                                    <li class="list-group-item list-group-item-primary col-3">${vehicle.km_daily}</li>
                                </ul>
                                <ul class="list-group list-group-horizontal fw-bold">
                                    <li class="list-group-item list-group-item-primary col-9">Monthly Rate (Rs.)</li>
                                    <li class="list-group-item list-group-item-primary col-3">${vehicle.monthly_rate}</li>
                                </ul>
                                <ul class="list-group list-group-horizontal fw-bold">
                                    <li class="list-group-item list-group-item-primary col-9">Monthly KM</li>
                                    <li class="list-group-item list-group-item-primary col-3">${vehicle.km_monthly}</li>
                                </ul>
                                <ul class="list-group list-group-horizontal fw-bold">
                                    <li class="list-group-item list-group-item-primary col-9">Rate Per Extra KM (Rs.)</li>
                                    <li class="list-group-item list-group-item-primary col-3">${vehicle.extra_km_rate}</li>
                                </ul>
                                <ul class="list-group list-group-horizontal fw-bold mt-2">
